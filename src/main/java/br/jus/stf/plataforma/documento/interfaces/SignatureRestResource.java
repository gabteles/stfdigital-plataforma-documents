...
import br.jus.stf.plataforma.documento.application.command.PostSignCommand;
import br.jus.stf.plataforma.documento.application.command.PreSignCommand;
import br.jus.stf.plataforma.documento.application.command.PrepareCommand;
import br.jus.stf.plataforma.documento.application.command.ProvideToSignCommand;
