...
public class V1_4__Carga_certificado_digital implements SpringJdbcMigration {
    ...
    public void migrate(JdbcTemplate jdbcTemplate) throws Exception {
        ...
        List<String> certificadosParameters = Arrays.asList(
                "cn=Autoridade Certificadora Raiz Brasileira v2 ou=Instituto Nacional de Tecnologia da Informacao – ITI o=ICP-Brasil c=BR, 01, certification/pkis/icp-brasil/acrb-v2.cer, 21/06/2010 17:04:57, 21/06/2023 17:04:57, 0, R, ICP_BRASIL",
                "cn=Autoridade Certificadora da Justica v4 ou=Autoridade Certificadora Raiz Brasileira v2 o=ICP-Brasil c=BR, 09, certification/pkis/icp-brasil/ac-jus-v4.cer, 22/11/2011 15:15:01, 22/11/2021 15:15:01, 1, A, ICP_BRASIL",
                "cn=AC CAIXA-JUS v2 ou=Autoridade Certificadora da Justica - AC-JUS o=ICP-Brasil c=BR, 03, certification/pkis/icp-brasil/ac-caixa-jus-v2.cer, 28/12/2011 11:03:21, 28/12/2019 11:03:21, 1, A, ICP_BRASIL",
                "cn=AC CAIXA v2 ou=Autoridade Certificadora Raiz Brasileira v2 o=ICP-Brasil c=BR, 0b, certification/pkis/icp-brasil/ac-caixa-v2.cer, 02/12/2011 10:16:53, 02/12/2021 10:16:53, 3, A, ICP_BRASIL",
                "cn=AC CAIXA PF v2 ou=Caixa Economica Federal o=ICP-Brasil c=BR, 28eea57c362904d8, certification/pkis/icp-brasil/ac-caixa-pf-v2.cer, 23/12/2011 11:52:58, 21/12/2019 11:52:58, 1, A, ICP_BRASIL");
    ...
    private void salvarCertificado(JdbcTemplate jdbcTemplate, String command, Long certificadoId, String[] parameters)
        ...
        try {
            stream = ClassLoader.getSystemClassLoader().getResourceAsStream(parameters[2]);
