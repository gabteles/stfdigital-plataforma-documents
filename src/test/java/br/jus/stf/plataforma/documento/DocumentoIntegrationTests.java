...
public class DocumentoIntegrationTests extends AbstractIntegrationTests {
    ...
    public void enviarArquivoSemAssinatura() throws Exception {
        ...
        mockMvc.perform(fileUpload("/api/documentos/conteudo/assinado")
                .file(mockArquivo)
    ...
    public void enviarArquivoAssinado() throws Exception {
        ...
        String idTemp = mockMvc.perform(fileUpload("/api/documentos/conteudo/assinado")
                .file(mockArquivo)
                .contentType(MediaType.MULTIPART_FORM_DATA)
                .content(arquivo))
        ...
        JavaType type = TypeFactory.defaultInstance().constructParametrizedType(ArrayList.class, ArrayList.class,
                DocumentoTemporarioDto.class);
    ...
    @Test
    @WithMockOauth2User(value = "organizador-pecas", components = { "upload-documento", "salvar-documentos",
            "dividir-documentos-completamente", "unir-documentos" })
    public void dividirEUnirDocumentos() throws Exception {
        ...
        String documentosDivididos = mockMvc
                .perform(post("/api/documentos/" + documentoId + "/divisao")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(dividirDocumentoCommandJsonStr))
                .andExpect(status().is2xxSuccessful())
        ...
        mockMvc.perform(post("/api/documentos/uniao")
                .contentType(MediaType.APPLICATION_JSON)
    ...
    @Test
    @WithMockOauth2User(value = "organizador-pecas",
            components = { "upload-documento", "salvar-documentos", "dividir-documentos-completamente" })
    ...
    private Integer fazerUploadDocumento() throws Exception {
        ...
        String idTemp = mockMvc.perform(fileUpload("/api/documentos/conteudo")
                .file(mockArquivo)
                .contentType(MediaType.MULTIPART_FORM_DATA)
                .content(arquivo))
                .andExpect(status().is2xxSuccessful())
