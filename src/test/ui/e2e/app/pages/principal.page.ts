...
export class PrincipalPage {
	...
	private linkEdicaoConteudoModelo: ElementFinder = element(by.css('div[ui-sref="app.novo-processo.modelos-conteudo-editar"]'));
    ...
    public iniciarEdicaoConteudoModelo() : void {
    	this.linkEdicaoConteudoModelo.click();
    	browser.sleep(5000);
    }
